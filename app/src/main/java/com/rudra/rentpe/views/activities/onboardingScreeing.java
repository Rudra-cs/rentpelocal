...
public class onboardingScreeing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_onboarding_screeing);
    ...
    public void getStartedFun(View view) {
        Intent i = new Intent(onboardingScreeing.this, Dashboard.class);
        startActivity(i);
        finish();
    }
}